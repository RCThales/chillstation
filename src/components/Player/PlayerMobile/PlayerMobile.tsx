...
const PlayerMobile = () => {
  ...
  return (
    <>
      ...
      {fullSize ?      
      <section className='fixed h-full bottom-20 z-[999] w-screen gap-4 backdrop-blur-sm bg-fuchsia-400/50 justify-center items-center flex flex-col md:hidden'>
        <button onClick={toggleFullsize} className='absolute top-6 left-6 text-zinc-800 z-[9999]'>BACK</button>
        <Image priority src={"https://chillstation.s3.amazonaws.com/public/500x500.jpg"} className='max-w-[90vw] h-auto shadow-lg shadow-fuchsia-400 rounded-md w-[500px] m-auto' width={1500} height={1500} alt={"Song cover-art."}></Image>
